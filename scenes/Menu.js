class Menu extends Phaser.Scene {
    ...
    create() {
        ...
        // for tounchble 
        this.btn_play.setInteractive().on('pointerup', (pointer, localX, localY, event) => {
        ...
        this.btn_score.setInteractive().on('pointerup', (pointer, localX, localY, event) => {
            this.scene.transition({
                target: "ScoreScene",
                moveAbove: true,
                duration: 300,
        ...
        this.btn_help.setInteractive().on('pointerup', (pointer, localX, localY, event) => {
            this.scene.transition({
                target: "HelpScene",
                moveAbove: true,
                duration: 300,
        ...
        this.about.setInteractive().on('pointerup', (pointer, localX, localY, event) => {
            this.scene.transition({
                target: "ContactScene",
                moveAbove: true,
                duration: 300,
